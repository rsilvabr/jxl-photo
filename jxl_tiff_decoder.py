    ...
    with tempfile.TemporaryDirectory(prefix="tiff_", dir=TEMP_DIR) as tmp:
        ...
        try:
            ...
            if mode == 'roundtrip':
                ...
                logger.info(" >Using None decode (djxl auto, no ICC)")
                ...
                logger.info(" >Using Basic decode (djxl auto + ICC from output)")
                ...
                if djxl_icc:
                    logger.info(" >ICC extracted from djxl output")
                else:
                    logger.info(" >No ICC in djxl output")
