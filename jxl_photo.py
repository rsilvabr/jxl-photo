...
class FolderAnalyzer:
    ...
    def detect_mode_for_entry(self, source: str, dest: str, original_mode: int = 0) -> int:
        ...
        - Preserves explicitly generated manifest modes (6 / 7) when source/dest
          are inside an export marker folder.
        ...
        # Preserve mode 6 / 7 generated by generate_manifest when running from manifest.
        marker_lower = self.export_marker.lower()
